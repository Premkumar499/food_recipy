              ...
              {navigationItems.map((item, index) => (
                <div key={item.name} className="group">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 rounded-xl hover:bg-gradient-to-r hover:from-orange-500/20 hover:to-red-500/20 transition-all duration-300 cursor-pointer"
                  >
                    ...
                    <svg 
                      className={`w-5 h-5 transition-transform duration-300 ${
                        expandedCategories.includes(item.name) ? 'rotate-180' : ''
                      }`} 
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                  ...
                  {/* Dropdown Items - Now collapsible */}
