...
const DesktopSidebar = ({ isOpen, onToggle, navigationItems }: DesktopSidebarProps) => {
  return (
    <aside 
      className={`hidden lg:block fixed top-0 left-0 h-full bg-gradient-to-b from-gray-900 via-gray-800 to-black text-white shadow-2xl transform transition-all duration-300 ease-in-out z-50 ${
        isOpen ? 'w-80' : 'w-0'
      } overflow-hidden`}
    >
